...
async def ping(e):
    if e.sender_id in SUDO_USERS:
        ...
        pingop = f"𝐌𝐀𝐑𝐂𝐔𝐒 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 `{ms}` ᴍs"                   
        await fuk.edit(pingop)


# ALIVE

RIZ_PIC = ALIVE_PIC if ALIVE_PIC else "https://telegra.ph/file/3f77d0b25b85eaadaef95.jpg"


rizoel = "✧ 𝐌𝐀𝐑𝐂𝐔𝐒 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓 𝐇𝐄𝐑𝐄 ✧\n\n"
...
rizoel += f"┣➣ **MARCUS SPAM BOT VERSION**  : `{marcus version}`\n"
...
HELP_PIC = "https://telegra.ph/file/3f77d0b25b85eaadaef95.jpg"

RiZoeLX = "🔥𝐌𝐀𝐑𝐂𝐔𝐒 𝐒𝐏𝐀𝐌 𝐁𝐎𝐓🔥\n\n"
 
RiZoeLX += f"__ᴄᴍᴅs ᴀᴠᴀɪʟᴀʙʟᴇ ɪɴ MARCUS SPAM BOT__\n\n"
